...
const Footer = () => {
  return (
    <>
      <div className="mt-20 flex justify-center bg-gray-100">
        ...
        <div className="m-16">
          <h3 className="text-xl font-medium">ABOUT KHAOJI</h3>
          <Link to="/about">
            <p className="text-lg text-slate-500 pt-2 pb-1 hover:text-red-600 hover:scale-y-110 transition-all duration-200">
              About
            </p>
          </Link>
          <a className="anc" href="#" target="_blank">
            <p className="text-lg text-slate-500 py-1 hover:text-red-600 hover:scale-y-110 transition-all duration-200">
              Careers
            </p>
          </a>
          <a className="anc" href="#" target="_blank">
        ...
        <div className="m-16 flex flex-col items-center ">
          ...
          <div className="flex py-7">
            <Link to="https://www.Linkedin.com/">
              <img
                className="w-7 mx-1 hover:scale-y-110 transition-all duration-200"
                src={linkedin}
                alt="linkedin"
              />
            </Link>
          ...
          <div className="social-img">
            <Link to="https://www.playstore.com/">
              <img
                className="w-40 mb-2 hover:scale-y-110 transition-all duration-200"
                src={play_store}
                alt="Play Store"
              />
            </Link>
